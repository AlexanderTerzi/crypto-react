...
interface IPriceIndicatorProps {
    currentPrice: string | number;
    highPrice: string | number;
    lowPrice: string | number;
}

const PriceIndicator: React.FC<IPriceIndicatorProps> = ({ currentPrice, highPrice, lowPrice }) => {
    const [greenIndicator, setGreenIndicator] = useState(0);

    useEffect(() => {
        let totalPrice = Number(currentPrice) - Number(lowPrice);
        let greenColor = ((Number(highPrice) - Number(currentPrice)) * 100) / totalPrice;

        setGreenIndicator(Math.ceil(greenColor));
    }, [currentPrice, highPrice, lowPrice]);

    return (
        <>
            <span className='bg-red h-1.5 rounded-l-lg w-[50%]'
                style={{ width: `${100 - greenIndicator}%` }}>
                &nbsp;
            </span>
            <span className='bg-green h-1.5 rounded-r-lg w-[50%]'
                style={{ width: `${greenIndicator}%` }}>
                &nbsp;
            </span>
        </>
    ...
    return ReactDOM.createPortal(
        <div
            ...
            <div
                ...
                {(typeof (coinData) === 'object') && coinData.length !== 0 && status !== 'loading' && (
                    <div className='flex lg:flex-col items-center justify-between h-full w-full p-4 ssm:p-1'>
                                ...
                                <div className='flex flex-col w-full'>
                                    <div className='flex justify-between '>
                                        ...
                                        <div
                                            ...
                                            ${coinData.market_data.price_change_percentage_24h > 0 ? 'bg-green text-green' : 'bg-red text-red'}`}>
                                            <span>
                                            ...
                                            <svg
                                                ...
                                                className={`${coinData.market_data.price_change_percentage_24h > 0 ? 'fill-green rotate-180' : 'fill-red'} mb-0.5 ml-0.5 w-[1rem]`}>
                                    ...
                                    <div className='flex justify-between '>
                                        <div
                                            ...
                                            <svg
                                                ...
                                                fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className='fill-green rotate-180 mb-0.5 ml-0.5 w-[1rem]'>
                                                <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div className='flex justify-between '>
                                        <div
                                            ...
                                            <svg
                                                ...
                                                fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                                className='fill-red mb-0.5 ml-0.5 w-[1rem]'>
                                                <path d="M7.47951 11.4153C7.42599 11.493 7.35438 11.5565 7.27085 11.6004C7.18732 11.6444 7.09437 11.6673 7.00001 11.6673C6.90564 11.6673 6.81269 11.6444 6.72916 11.6004C6.64563 11.5565 6.57402 11.493 6.52051 11.4153L1.27051 3.83194C1.20974 3.74447 1.1741 3.64202 1.16747 3.53572C1.16084 3.42943 1.18346 3.32334 1.23289 3.229C1.28232 3.13466 1.35665 3.05567 1.44782 3.0006C1.53899 2.94554 1.6435 2.91652 1.75001 2.91669H12.25C12.3563 2.91713 12.4604 2.94652 12.5512 3.00172C12.642 3.05691 12.716 3.13581 12.7653 3.22993C12.8147 3.32406 12.8374 3.42984 12.8311 3.53591C12.8247 3.64199 12.7896 3.74433 12.7295 3.83194L7.47951 11.4153Z" />
                                            </svg>
                                        </div>
                                    </div>
                        ...
                        <div className='absolute bottom-8 right-8 flex items-center lg:static'>
                            ...
                            {coinData.links.twitter_screen_name && <a
                                className='text-lg px-1'
                                href={`https://twiiter.com/${coinData.links.twitter_screen_name}`}
                                target="_blank"
                                rel="noreferrer">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            {coinData.links.subreddit_url && <a
                                className='text-lg px-1'
